...
export function LineaireAnnulaire({ x, y, rotation, selected, onSelect, onDragMove, onDragEnd, onDblClick }: LineaireAnnulaireProps) {
  const r = 12;
  ...
  return (
    ...
    >
      ...
      {/* Vertical axis line through circle */}
      <Line
        points={[0, -(r + 8), 0, r + 8]}
        stroke={strokeColor}
